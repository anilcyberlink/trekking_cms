        ...
        <div class="container">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-6">
                        <img src="{{ asset('theme-assets/assets/mountain.jpg') }}" alt="login"
                    ...
                    <div class="col-md-6">
                        <div class="card-body">
                            <div class="brand-wrapper">
                                <img src="{{ asset('theme-assets/assets/treklogo.jpg') }}" alt="logos"
                                    width="200">
                            ...
                            <form class="needs-validation" method="POST" action="{{ route('login') }}">
                                ...
                                <button id="login" class="btn btn-block login-btn mb-4" type="submit">Sign
                                    In</button>
                            </form>
                        </div>
                    </div>
