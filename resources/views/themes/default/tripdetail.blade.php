            ...
            <div class="flex flex-col lg:flex-row gap-9">
                <div class="w-full lg:w-2/3 ">
                    <div class="grid grid-cols-1 gap-4">
                        <div>
                            <a href="{{ $data->banner ? asset('/uploads/banners/' . $data->banner) : asset('theme-assets/assets/trip/8000.jpg') }}"
                                data-fancybox="trip-gallery" data-caption="{{ $data->banner_alt }}">
                                <div class="relative rounded-2xl overflow-hidden group cursor-pointer h-full md:h-[480px]">
                                    <img src="{{ $data->banner ? asset('/uploads/banners/' . $data->banner) : asset('theme-assets/assets/trip/8000.jpg') }}"
                                        alt="{{ $data->banner_alt }}" loading="lazy"
                                ...
                                @if ($key <= 2)
                                    <div class="relative">
                                        <a href="{{ $photo->thumbnail ? asset('/uploads/original/' . $photo->thumbnail) : asset('theme-assets/assets/trip/8000.jpg') }}"
                                            data-fancybox="trip-gallery" data-caption="{{ $photo->title }}">
                    ...
                    @foreach ($photos as $key => $photo)
                        @if ($key > 2)
                            <a href="{{ asset('/uploads/original/' . $photo->thumbnail) }}" data-fancybox="trip-gallery"
                                data-caption="{{ $photo->title }}" class="hidden">
                            </a>
                        @endif
                    @endforeach
                </div>
                ...
                <div class="w-full lg:w-1/3">
                    <div class=" space-y-8">
                                ...
                                <div class="w-full p-5 bg-gray-50 rounded-xl border border-brand-100 space-y-7">
                                    ...
                                    <div>
                                        ...
                                        <div class="flex items-baseline justify-start mb-2">
                                            <span id="price"
                                                class="text-4xl font-extrabold text-blue-600">${{ $data->price }}</span>
                        ...
                        <div class="flex justify-between px-2 text-xs font-bold text-gray-500">
                            ...
                            <a href="{{ route('trip.download', $data->uri) }}"
                                class="flex items-center hover:text-brand-400" target="_blank">
            ...
            <div class="flex gap-8">
                ...
                <div class="flex-1 ">
                    ...
                    <section class="pb-6" id="overview">
                        <div class="space-y-4  md:space-y-6">
                            ...
                            <div
                                ...
                                <div class="flex items-start space-x-2">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-base font-semibold text-black/80">
                                            {{ grade_message_trek($data->trip_grade) }}</p>
                                    </div>
                                </div>
                                <div class="flex items-start space-x-2">
                                    <div class="inline-flex items-center justify-center text-brand-400">
                            ...
                            <div class=" max-w-none text-gray-700 space-y-4">
                                <h2 class="text-2xl  font-bold text-gray-900 text-gray-900">{{ $data->trip_title }}
                                    Overview</h2>
                                        ...
                                        @foreach ($itinerary as $key => $value)
                                            <div id="heading-{{ $key + 1 }}">
                                                <button type="button"
                                                    ...
                                                    data-accordion-target="#body-{{ $key + 1 }}"
                                                    aria-expanded="true" aria-controls="body-{{ $key + 1 }}">
                                                        ...
                                                        <div
                                                            ...
                                                            @if ($value->distance || $value->duration)
                                                                <div class="flex items-center">
                                                                    ...
                                                                    <span
                                                                        class="font-semibold">{{ $value->distance }}</span>
                                                                </div>
                                                            @endif
                                                            @if ($value->distance || $value->duration)
                                                                <div class="flex items-center">
                                                                    ...
                                                                    <span
                                                                        class="font-semibold">{{ $value->duration }}</span>
                                                                </div>
                                                            @endif
                                                        </div>
                                                    @endif
                                    ...
                                    <div id="alert-additional-content-1"
                                        ...
                                        <div class="flex items-center justify-between">
                                            <div class="flex items-start">
                                                ...
                                                <div>
                                                    <h3 class="font-medium">If the above {{ $data->trip_title }} itinerary
                                                        does not meet your needs, we can design individualized travel plans
                                                        based on your preferences and specifications.</h3>
                                                    <a href="{{ route('customize-trip', $data->uri) }}"
                                                        class="hidden sm:inline-flex text-white bg-brand-400 hover:bg-brand-500 mt-2
                                                ...
                                                <ul class="space-y-3 text-sm">
                                                    @foreach ($cost_includes as $key => $value)
                                                        <li class="flex items-start">
                                                            <i
                                                                class="far fa-check-circle text-green-500 mt-1 mr-3 shrink-0"></i>
                                                            <span>
                                                                {{ $value->title }}
                                                            </span>
                                                        </li>
                                            ...
                                            <div>
                                                <ul class="space-y-3 text-sm">
                                                    @foreach ($cost_excludes as $key => $value)
                                                        <li class="flex items-start">
                                                            <i
                                                                class="far fa-times-circle text-red-500 mt-1 mr-3 shrink-0"></i>
                        ...
                        <section class="py-6" id="departures">
                            <div class="">
                                <div class="mb-8">
                                    ...
                                    <div
                                        class="p-4 mb-4 text-sm text-brand-900 rounded-base bg-brand-50 border border-brand-100   ">
                                        <b> Start dates</b> indicate your arrival in Nepal, and <b>end dates</b> reflect
                                        your Departures from Nepal. The scheduled Departuress for the
                                        {{ $data->trip_title }} are specifically organized for group joining option. If the
                                        listed dates do not fit your availability, please reach out to us, and our team will
                                        provide alternative date options.
                                    </div>
                                    <div class="relative overflow-x-auto border rounded-xl shadow-sm">
                                        <div class="Departures-list bg-white shadow-base py-3">
                                            <!--  -->
                                            <ul
                                                class="[&>li+li]:border-t [&>li+li]:border-t-gray-200 before:border-gray-200">
                                                    ...
                                                    <li>
                                                        <div
                                                            ...
                                                            <div class="col">
                                                                ...
                                                                <span
                                                                    class="text-brand-900 font-semibold">{{ $row->start_date }}</span>
                                                            </div>
                                                            @if ($row->end_date)
                                                                <div class="col">
                                                                    <span class="text-xs block pb-0.5">End Date</span>
                                                                    <span
                                                                        class="text-brand-900 font-semibold">{{ $row->end_date }}</span>
                                                                </div>
                                                            @endif
                                                            <div class="col">
                                                                <div class="availability">
                                                                    <div class="flex items-center gap-x-2">
                                                                        ...
                                                                        @else
                                                                            <span
                                                                                class="inline-flex items-center px-2 py-1 rounded-xl bg-red-50 text-red-600 text-xs font-medium border border-red-200">
                                                                                <i class="fa fa-times mr-1"></i> Fully
                                                                                Occupied </span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                    ...
                                    @if ($data->trip_map)
                                        <div id="route-map">
                                            <div class="flex justify-between items-center mb-6">
                                                ...
                                                <a href="{{ asset('uploads/original/' . $data->trip_map) }}" download
                                            ...
                                            <div class="rounded-xl overflow-hidden border border-gray-200  aspect-video">
                                                <a href="{{ asset('uploads/original/' . $data->trip_map) }}"
                                                    ...
                                                    <img src="{{ asset('uploads/original/' . $data->trip_map) }}"
                                                        alt="{{ $data->tripmap_alt }}" loading="lazy"
                                    ...
                                    @if ($data->trip_video)
                                        <div id="video">
                                            ...
                                            <div
                                                ...
                                                <img src="https://i.ytimg.com/vi/{{ $data->trip_video }}/hqdefault.jpg"
                                                    alt="{{ $data->trip_title }}" loading="lazy"
                                                ...
                                                <div
                                                    ...
                                                    <a href="https://www.youtube.com/watch?v={{ $data->trip_video }}"
                                                        data-fancybox
                        ...
                        <div class="">
                            ...
                            <div>
                                ...
                                @foreach ($reviews as $review)
                                    <div
                                        class="bg-gray-50 p-6 rounded-2xl border border-gray-200 mb-8 relative overflow-hidden">
                                        ...
                                        @foreach ($faqs as $key => $value)
                                            <div id="accordion-card-heading-{{ $key + 1 }}">
                                                <button type="button"
                                                    ...
                                                    data-accordion-target="#accordion-card-body-{{ $key + 1 }}"
                                                    aria-expanded="false"
                    ...
                    <div class="sticky bottom-0 left-0 z-30 w-full h-16 bg-neutral-primary-soft border-t border-default">
                        <div
                            class="grid h-full max-w-xl grid-cols-2 mx-auto font-medium items-center text-center px-4 gap-5">
                                ...
                                @foreach ($similar_trips as $row)
                                    <a href="{{ route('trip.tripdetail', $row->uri) }}"
                                        ...
                                        <div class="relative h-64 overflow-hidden">
                                            <img src="{{ $row->thumbnail ? asset('uploads/thumbnails/' . $row->thumbnail) : asset('theme-assets/assets/trip/2.jpg') }}"
                                                alt="{{ $row->thumbnail_alt }}" class="w-full h-full object-cover">
                                        </div>
                                        <div class="p-5">
                                            ...
                                            <div
                                                ...
                                                <span class="flex items-center gap-1 text-xs">
                                                    <img src="{{ asset('theme-assets/assets/icons/map-point.svg') }}"
                                                        class="h-4"> {{ optional($row->destinations->first())->title }}
                                                </span>
                                                <span class="flex items-center gap-1">
                                                    <img src="{{ asset('theme-assets/assets/icons/clock.svg') }}"
                                                        class="h-4"> {{ $row->duration }} </span>
                                                <span class="flex items-center gap-1">
                                                    <img src="{{ asset('theme-assets/assets/icons/spring.svg') }}"
                                                        class="h-4"> {{ $row->best_season }} </span>
                                            </div>
                                            <div class="flex justify-between items-end">
                                                <div>
                                                    <p class="text-sm text-slate-400 font-medium"></p>
                                                    <p class="text-xl font-bold text-slate-900">US$ {{ $row->price }}
                                                    </p>
                                                </div>
                                                <button
            ...
            <div class="relative bg-neutral-primary-soft border border-default rounded-xl shadow-sm  ">
                ...
                <form action="{{ route('custom-trip-post') }}" method="post">
                    ...
                    <div class="flex items-center space-x-4 border-t border-default p-4">
                        <button type="submit"
                            class="flex items-center  text-white bg-brand-400 hover:bg-brand-500 font-medium rounded-xl text-sm px-5 py-3 transition shadow-sm">
                            Submit </button>
                    </div>
                </form>
            </div>
                        ...
                        <div class="grid gap-6 grid-cols-1">
                            ...
                            <fieldset class="space-y-3">
                                ...
                                <div class="flex flex-col sm:flex-row items-center gap-2 w-full">
                                    ...
                                    <!-- Rating Text -->
                                    <div id="rating-text"
                                        class="mt-2 sm:mt-0 sm:ml-2 text-gray-600 font-normal text-sm sm:text-base text-center sm:text-left">
                                    </div>
                                </div>
