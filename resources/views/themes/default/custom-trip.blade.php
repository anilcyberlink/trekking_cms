    ...
    <section class="py-16 relative">
        <div class="container ">
            <div class="lg:w-9/12 lg:mx-auto space-y-6">
                ...
                <p class="text-lg text-gray-500">Looking for a private or customized trekking experience? Whether you’re
                    traveling with family, friends, or at your own pace, Summit 8000 creates tailor-made treks across Nepal.
                    Share your travel dates and interests, and we’ll design a personalized itinerary just for you.</p>
                    ...
                    <div class="grid gap-4 grid-cols-2 ">
                        <div class="col-span-2">
                            ...
                            <input
                                ...
                                value="{{ $trips->trip_title }}" readonly>
                        </div>
                    ...
                    <div>
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-brand-900">{{ $setting->email_primary }} <br>
                                    {{ $setting->email_secondary }}</p>
                            </div>
                        </div>
                    </div>
                    <div>
